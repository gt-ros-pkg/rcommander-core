"""autogenerated by genmsg_py from LinearMovementAction.msg. Do not edit."""
...
class LinearMovementAction(roslib.message.Message):
  _md5sum = "0d8e80dee08e07f1e6bf8c3e67b6803f"
  _type = "ptp_arm_action/LinearMovementAction"
...
"""
  ...
  _slot_types = ['ptp_arm_action/LinearMovementActionGoal','ptp_arm_action/LinearMovementActionResult','ptp_arm_action/LinearMovementActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LinearMovementAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = ptp_arm_action.msg.LinearMovementActionGoal()
      if self.action_result is None:
        self.action_result = ptp_arm_action.msg.LinearMovementActionResult()
      if self.action_feedback is None:
        self.action_feedback = ptp_arm_action.msg.LinearMovementActionFeedback()
    else:
      self.action_goal = ptp_arm_action.msg.LinearMovementActionGoal()
      self.action_result = ptp_arm_action.msg.LinearMovementActionResult()
      self.action_feedback = ptp_arm_action.msg.LinearMovementActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B2d3I.pack(_x.action_goal.goal.relative, _x.action_goal.goal.trans_vel, _x.action_goal.goal.rot_vel, _x.action_goal.goal.goal.header.seq, _x.action_goal.goal.goal.header.stamp.secs, _x.action_goal.goal.goal.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.action_result.result.error.x, _x.action_result.result.error.y, _x.action_result.result.error.z, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.action_feedback.feedback.error.x, _x.action_feedback.feedback.error.y, _x.action_feedback.feedback.error.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.relative, _x.action_goal.goal.trans_vel, _x.action_goal.goal.rot_vel, _x.action_goal.goal.goal.header.seq, _x.action_goal.goal.goal.header.stamp.secs, _x.action_goal.goal.goal.header.stamp.nsecs,) = _struct_B2d3I.unpack(str[start:end])
      ...
      (_x.action_result.result.error.x, _x.action_result.result.error.y, _x.action_result.result.error.z, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.error.x, _x.action_feedback.feedback.error.y, _x.action_feedback.feedback.error.z,) = _struct_3d.unpack(str[start:end])
      return self
