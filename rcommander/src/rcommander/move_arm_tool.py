...
class MoveArmTool(tu.ToolBase):
    ...
    def __init__(self, rcommander):
        tu.ToolBase.__init__(self, rcommander, 'save_move_joint', 'Safe Move')
    ...
    def _create_node(self, name=None):
        ...
        for name in self.joint_name_fields:
            ...
            joints.append(rad)
        return MoveArmState(nname, str(self.arm_box.currentText()), joints)

    def _node_selected(self, my_node):
        self.arm_box.setCurrentIndex(self.arm_box.findText(my_mode.arm))
        for idx, name in enumerate(self.joint_name_fields):
