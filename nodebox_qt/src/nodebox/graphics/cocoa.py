...
class Image(Grob, TransformMixin):
    ...
    def __init__(self, ctx, path=None, x=0, y=0, width=None, height=None, alpha=1.0, image=None, data=None):
        ...
        if data is not None:
            ...
            self._nsImage.setDataRetained_(True) # Retain the original contents for hi-res images.
            ...
            if image is None:
                ...
                image.setDataRetained_(True) # Retain the original contents for hi-res images.
